...
const Header = () => {
    ...
    return (
        <header className={clsx(
            ...
            hasScrolled && "py-2 bg-black-100 backdrop-blur-[8-px]"
            )}
        >
                        ...
                        <nav className="max-lg:relative max-lg:z-2 max-lg:my-auto">
                            <ul className="flex max-lg:block max-lg:px-12">
                                ...
                                <li className="nav-logo">
                                    <LinkScroll to="hero" spy smooth offset={-250} className={clsx("max-lg:hidden transition-transform duration-500 cursor-pointer")}>
